...
**Tabs Implemented**:
1. ✅ **Key Management**
   - Generate role-based RSA-4096 key pairs (sender/receiver)
   - Secure passphrase prompting with masking
   - Load existing encrypted private keys
   - Load public key PEM files
...
**Key Features**:
- Role-based keypair generation (sender/receiver) organized under `output_dir/<role>/`
...
│   ├── sender/                             # Sender's keys (generated by demo/GUI)
│   │   ├── private_key_encrypted.json
│   │   └── public_key.pem
│   └── receiver/                           # Receiver's keys (generated by demo/GUI)
│       ├── private_key_encrypted.json
│       └── public_key.pem
│
